...
const MANUAL_TRANSLATIONS = {
  ...
  スキルMod: '技能 Mod',
  エーテル: '乙太',
  '片手武器・両手武器・弓・チャーム・盾・頭・胴体に備わるソケットに装着可能なアイテム。':
    '符文可鑲嵌在單手武器、雙手武器、弓、Charm（護石）、盾牌、頭部與胴體等裝備的 Socket 中。',
  '弓は両手武器扱い、チャームは片手武器扱い（一部のみ防具）、盾は防具扱い。':
  ...
  '片手武器（両手は数値x2）': '單手武器（雙手武器數值 x2）',
  '+7% 全ステータス耐性': '+7% 全狀態異常抗性',
  '+15% 全ステータス耐性': '+15% 全狀態異常抗性',
  '-0.07 武器の速度 ※チャームは防具効果で適用': '-0.07 武器速度 ※Charm 套用防具效果',
  '+12 被ダメージ時回復 マナ': '+12 Mana 受擊時恢復',
  '+12 被ダメージ時回復 スピリット': '+12 Spirit 受擊時恢復',
  '+10% 攻撃能力 ※チャームは防具効果で適用': '+10% Attack Rating ※Charm 套用防具效果',
  '+20 武器ダメージ ※チャームは防具効果で適用': '+20 Weapon Damage ※Charm 套用防具效果',
  '+10% 吸収する 出血': '+10% 出血吸收',
  '+10% 毒ダメージ': '+10% 毒素 Damage',
  '+10% 吸収する 毒': '+10% 毒素吸收',
  '+10% 雷ダメージ': '+10% 閃電 Damage',
  '+10% 吸収する 雷': '+10% 閃電吸收',
  '+10% 氷ダメージ': '+10% 冰冷 Damage',
  '+10% 吸収する 氷': '+10% 冰冷吸收',
  '+10% 炎ダメージ': '+10% 火焰 Damage',
  '+10% 吸収する 炎': '+10% 火焰吸收',
  '+10% アーケインダメージ': '+10% Arcane Damage',
  '+10% 吸収する アーケイン': '+10% Arcane 吸收',
  '+6% スキル 速度 ※チャームは防具効果で適用': '+6% Skill Speed ※Charm 套用防具效果',
  '+7% 強化 全属性': '+7% 全屬性強化',
  '-5% 全属性が低減': '-5% 敵人全屬性抗性',
  '+5% 吸収する 全属性': '+5% 全屬性吸收',
  '持ち帰るアイテム': '值得帶回的物品',
  ...
  '器用とクリティカルヒットの数値を元に計算が行われ、クリティカル率（%）が決定する。 器用によるクリティカル率上昇は器用を伸ばすほど効率が落ちていき、器用200付近のクリティカル率10%でほぼ伸びなくなる。クリティカルヒットは50ごとにクリティカル率2～3%程度の伸びを見せ、こちらも効率は落ちていく。':
    '暴擊率（%）會根據靈巧與暴擊數值計算。靈巧帶來的暴擊率提升會隨著靈巧堆高而遞減，約靈巧 200、暴擊率 10% 附近幾乎不再成長。暴擊數值每增加 50，大約可讓暴擊率增加 2～3%，但同樣會遞減。',
  'クリティカルは物理の場合、片手武器で150%・両手武器で200%、魔法の場合150%の増加が基本。 クリティカルヒットを50増加させてクリティカル率を3%上昇させたとして、150%なら実ダメージ1～1.5%、200%なら実ダメージ2～3%の増加となる。 クリティカルが極端に低い場合や、入れるルーンに困る魔法職なら伸ばすのもありかも。':
  ...
  装備Mods: '裝備 Mods',
  '装備に付与される項目の一覧。': '裝備上可能出現的 Mod 項目一覽。',
  'ダメージ強化 / 攻撃速度増加 / ブロック率 / ブロック率増加 / 物理防御強化 / 才能・タレント / ステータス / パッシブ / 要求 / クリティカルヒット / 攻撃能力 / 詠唱速度増加 / リソース / リジェネ / ヒット時回復 / キル時回復 / 被弾時回復 / 最大リソース / ダメージの軽減 / 物理耐性 / 属性耐性 / 吸収する 属性 / 状態異常耐性 / ダメージ近接 / スペルパワー / 属性ダメージ / 削減 敵 耐性 / 移動速度 / 獲得率 / ダメージ強化 vs タイプ / スキル強化 / 効果 / エーテル / 不滅 / ソケット':
  ...
  '武器にのみ付与される Mod であり、武器ダメージを強化する。 装備に表示されている数値やDPSはダメージ強化が乗った後のもの。':
    '只會出現在武器上的 Mod，用來強化武器 Damage。裝備面板顯示的數值與 DPS，已經包含 Damage 強化後的結果。',
  '武器にのみ付与される Mod であり、武器のスピードを強化する。 装備に表示されている数値やDPSは攻撃速度増加が乗った後のもの。':
    '只會出現在武器上的 Mod，用來提高武器 Speed。裝備面板顯示的數值與 DPS，已經包含攻擊速度增加後的結果。',
  '盾にのみ付与される Mod であり、ブロックの発動率を示している。 この数値はあくまで発動率であり、ブロック時の基本ダメージカット率は25%である。 またタンク職はブロック率に20%が加算される。':
    '只會出現在盾牌上的 Mod，表示格擋觸發率。這個數值只是觸發率；格擋時的基礎 Damage 減免率為 25%。另外，坦職會在格擋率上額外加算 20%。',
  '盾にのみ付与される Mod であり、ブロック率を強化する。 装備に表示されているブロック率はブロック率増加が乗った後のもの。':
    '只會出現在盾牌上的 Mod，用來提高格擋率。裝備面板顯示的格擋率，已經包含格擋率增加後的結果。',
  '防具にのみ付与される Mod であり、物理防御を強化する。 装備に表示されている物理防御は物理防御強化が乗った後のもの。':
    '只會出現在防具上的 Mod，用來強化物理防禦。裝備面板顯示的物理防禦，已經包含物理防禦強化後的結果。',
  '才能・タレント': '天賦',
  'キャラクターの該当するタレントを上昇させる。複数ある場合、同一のタレントは抽選されない。 武器・盾・サブ・頭・胴体・手・腰・ネックレス・指輪に付与されていることが多い。 才能は Talents、タレントは Talent の機械翻訳であり、複数形かどうかの違いしかない。':
    '提高角色對應的天賦。若同一件裝備有多個天賦詞綴，不會抽到相同天賦。這類詞綴常出現在武器、盾牌、副手、頭部、胴體、手套、腰帶、項鍊與戒指上。日文原站中的「才能」與「タレント」都是天賦的機翻，本質上只差在單複數。',
  'すべての才能': '所有天賦',
  'すべてのクラスのすべてのタレントを上昇させる。': '提高所有職業的所有天賦。',
  '全属性 クラス名 才能': '全屬性 職業名稱 天賦',
  '該当するクラスのすべてのタレントを上昇させる。': '提高指定職業的所有天賦。',
  才能ツリー: '天賦樹',
  '該当するタレントツリー内のすべてのタレントを上昇させる。': '提高指定天賦樹內的所有天賦。',
  '属性 才能': '屬性天賦',
  '出血、毒、アーケイン、雷、炎、氷。 すべてのクラスの該当する属性を持つタレントを上昇させる。 複数の属性を持つスキルは片方のみが適用される。 たとえばドルイドの Tornado は氷とアーケインのスキルだが、氷 才能のみが適用される。':
    '出血、毒素、Arcane、閃電、火焰、冰冷。提高所有職業中帶有該屬性的天賦。若技能同時有多種屬性，只會套用其中一種。例如德魯伊的 Tornado 同時是冰冷與 Arcane 技能，但只會套用冰冷天賦。',
  タレント: '天賦',
  '該当するタレントを上昇させる。': '提高指定天賦。',
  パッシブ: 'Passive',
  '全パッシブスキル、オフェンス、ディフェンス、片手斬り、片手鈍器、刺突、弓術、素手、両手斬り、両手鈍器、二刀流、二回攻撃、回避、受流し、反撃、Alteration、Conjuration、Evocation。':
    '全 Passive Skill、攻擊、防禦、單手斬擊、單手鈍器、刺擊、弓術、空手、雙手斬擊、雙手鈍器、雙持、Double Attack、閃避、招架、反擊、Alteration、Conjuration、Evocation。',
  '武器パッシブは物理スキルダメージやヒット率に大きく影響するため重要性が高い。 おおまかな目安としては武器パッシブ15で、物理スキルダメージが3.3%増加する。':
    '武器 Passive 對物理技能 Damage 與命中率影響很大，因此重要性很高。粗略估算，武器 Passive 15 大約可讓物理技能 Damage 增加 3.3%。',
  'スペルパッシブはそれほどスペルダメージを上昇させないため微妙。 Alteration は回復などの補助系、Conjuration は範囲系、Evocation は単体系に影響する傾向にある。':
    '法術 Passive 對 Spell Damage 的提升不算大，效益較微妙。Alteration 傾向影響恢復等輔助系，Conjuration 傾向影響範圍系，Evocation 傾向影響單體系。',
  要求: '需求',
  '装備の要求レベルを減少する。 装備に表示されている要求レベルは要求の減少が乗った後のもの。':
    '降低裝備需求等級。裝備面板顯示的需求等級，已經包含需求降低後的結果。',
  攻撃能力: 'Attack Rating',
  '物理スキルダメージやヒット率を増加させる。 物理スキルへの影響度合いとしては、攻撃能力100で筋力30～35相当。':
    '提高物理技能 Damage 與命中率。以對物理技能的影響來看，Attack Rating 100 大約相當於力量 30～35。',
  詠唱速度増加: '施法速度增加',
  'スペルの詠唱速度を増加させる。 詠唱速度増加の数値を元に呪文詠唱ヘイスト（%）の計算が行われ、詠唱速度が決定する。 おおまかな目安としては詠唱速度増加20で、呪文詠唱ヘイストが2.5%増加する。':
    '提高法術施法速度。系統會依施法速度增加數值計算法術施法 Haste（%），再決定實際施法速度。粗略估算，施法速度增加 20 大約會讓法術施法 Haste 增加 2.5%。',
  リソース: '資源',
  'ヘルス、マナ、スピリット。 各リソース値を増加させる。加算であるため元の数値が高くなるにつれて効果は低くなる。':
    'Health、Mana、Spirit。以固定值提高各資源；因為是加算，基礎數值越高，相對效益越低。',
  リジェネ: '恢復速度',
  'ヘルス、マナ、スピリット。 5秒ごとに数値ぶんだけ回復する。難易度によるペナルティなし。':
    'Health、Mana、Spirit。每 5 秒恢復等同於該數值的資源；不受難度懲罰。',
  ヒット時回復: '命中時恢復',
  'ヘルス、マナ、スピリット。 武器の通常攻撃や物理スキル発動時に回復。多段スキルは1回とみなされる。 難易度によるペナルティが存在し、ナイトメアは33%・ヘルは50%減少する。':
    'Health、Mana、Spirit。使用武器普通攻擊或發動物理技能時恢復；多段技能視為一次。此效果會受到難度懲罰：惡夢（Nightmare）減少 33%，地獄（Hell）減少 50%。',
  キル時回復: '擊殺時恢復',
  'ヘルス、マナ、スピリット。 敵を倒した時に回復する。自身が倒していなくとも回復。 難易度によるペナルティなし。':
    'Health、Mana、Spirit。敵人死亡時恢復；即使不是自己擊殺也會恢復。不受難度懲罰。',
  被弾時回復: '受擊時恢復',
  'ヘルス、マナ、スピリット。 攻撃を受けた時に回復する。ヒットしなくても回復。 難易度によるペナルティが存在し、ナイトメアは33%・ヘルは50%減少する。':
    'Health、Mana、Spirit。受到攻擊時恢復；即使沒有被命中也會恢復。此效果會受到難度懲罰：惡夢（Nightmare）減少 33%，地獄（Hell）減少 50%。',
  最大リソース: '最大資源',
  'ヘルス、マナ、スピリット。 各リソースを割合で増加させる。':
    'Health、Mana、Spirit。以百分比提高各資源上限。',
  '物理、魔法。 被ダメージを減算する。減算であるため元の数値が高くなるにつれて効果は低くなる。':
    '物理、魔法。以固定值扣減受到的 Damage；因為是減算，原本受到的 Damage 越高，相對效益越低。',
  物理耐性: '物理抗性',
  '割合で被物理ダメージを減少する。 盾、頭、胴体、腰、太腿に付与されていることが多い。':
    '以百分比降低受到的物理 Damage。這類詞綴常出現在盾牌、頭部、胴體、腰帶與腿甲上。',
  属性耐性: '屬性抗性',
  '全属性、出血、毒、アーケイン、雷、炎、氷。 各属性ごとに割合で被ダメージを減少する。全属性耐性に物理耐性は含まれない。':
    '全屬性、出血、毒素、Arcane、閃電、火焰、冰冷。依各屬性以百分比降低受到的 Damage；全屬性抗性不包含物理抗性。',
  '吸収する 属性': '屬性吸收',
  '出血、毒、アーケイン、雷、炎、氷。 各属性ごとに被ダメージの割合ぶんだけヘルスを回復する。':
    '出血、毒素、Arcane、閃電、火焰、冰冷。依各屬性，按照受到 Damage 的一定比例恢復 Health。',
  状態異常耐性: '狀態異常抗性',
  '全ステータス、スタン、恐怖、麻痺、沈黙。 状態異常にかかっている時間を短縮する。':
    '全狀態異常、眩暈、恐懼、麻痺、沉默。縮短受到狀態異常影響的時間。',
  ダメージ近接: '近戰 Damage',
  '出血、毒、アーケイン、雷、炎、氷。 通常攻撃と物理スキルダメージに数値を加算する。加算であるため元の数値が高くなるにつれて効果は低くなる。':
    '出血、毒素、Arcane、閃電、火焰、冰冷。為普通攻擊與物理技能 Damage 加算固定數值；因為是加算，基礎 Damage 越高，相對效益越低。',
  スペルパワー: 'Spell Power',
  '全、出血、毒、アーケイン、雷、炎、氷。 スペルダメージに数値を加算する。加算であるため元の数値が高くなるにつれて効果は低くなる。':
    '全、出血、毒素、Arcane、閃電、火焰、冰冷。為 Spell Damage 加算固定數值；因為是加算，基礎 Damage 越高，相對效益越低。',
  属性ダメージ: '屬性 Damage',
  '全スペル、出血、毒、アーケイン、雷、炎、氷。 各属性ダメージを増加させる。全スペルとあるが物理スキルにも効果がある。':
    '全 Spell、出血、毒素、Arcane、閃電、火焰、冰冷。提高各屬性 Damage；雖然寫作全 Spell，但也對物理技能有效。',
  'おそらくタレントや装備のスキルダメージ強化と同じ場所に加算されており、スキルダメージ強化が十分に積まれていると効率が落ちていく。おおまかな目安としては1/6程度の実ダメージ増加と考えてよい。':
    '推測會和天賦、裝備上的 Skill Damage 強化加在同一個乘區；若 Skill Damage 強化已經堆得很高，效率會逐漸下降。粗略估算，可視為約 1/6 的實際 Damage 增幅。',
  '削減 敵 耐性': '降低敵人抗性',
  '全、出血、毒、アーケイン、雷、炎、氷。上限は75%。 敵の属性耐性を減少させる。パーティーメンバーには影響しない。 おおまかな目安としては1/3程度の実ダメージ増加と考えてよい。':
    '全、出血、毒素、Arcane、閃電、火焰、冰冷。上限為 75%。降低敵人的屬性抗性；不會影響隊友。粗略估算，可視為約 1/3 的實際 Damage 增幅。',
  移動速度: '移動速度',
  'ダンジョンでの移動速度を増加させる。上限は500%。':
    '提高地城內的移動速度；上限為 500%。',
  獲得率: '獲得率',
  'レアドロップ率、ゴールド獲得率、経験値獲得率。 それぞれの獲得率を上昇させる。ゴールド獲得率は宝箱にも影響する。':
    'Rare Drop Rate、Gold 取得率、經驗值取得率。提高各項取得率；Gold 取得率也會影響寶箱。',
  'ダメージ強化 vs タイプ': 'Damage 強化 vs 類型',
  'ヒューマノイド、ビースト、アンデッド、デーモン、ドラゴンスキン、ミスティック、ジャイアンツ。 各モンスタータイプへのダメージを増加させる。 物理スキルはスキル強化や属性ダメージ強化と同枠だと思われ、1/6程度の実ダメージ増加となる。魔法スキルは倍率通りのダメージを増加させ、おそらくだが属性耐性・削減が二重にかかる。':
  ...
  スキル強化: 'Skill 強化',
  'スキルダメージを増加する。複数ある場合、同一のスキル強化を引いたら加算される。 属性ダメージやスキル強化が十分に積まれていると効率が落ちていく。 おおまかな目安としては1/6程度の実ダメージ増加と考えてよい。':
    '提高 Skill Damage。若同一裝備上有多個 Skill 強化，抽到相同 Skill 強化時會加算。若屬性 Damage 或 Skill 強化已經堆得很高，效率會逐漸下降。粗略估算，可視為約 1/6 的實際 Damage 增幅。',
  '各ラベルと該当クラス一覧': '各標籤與適用職業一覽',
  ラベル: '標籤',
  '通常攻撃を発動した時に確率で追加効果が発生する。 ヒットしなくても発動する。':
    '發動普通攻擊時，有機率觸發追加效果；即使命中判定失敗也會觸發。',
  '効果のダメージは固定ダメージ+Lv*nで決まり、耐性などの影響は受けない。 ただしDot系効果は耐性などの影響を受ける他、クリティカルも発生する。':
    '效果 Damage 由固定 Damage + Lv * n 決定，不受抗性等因素影響。不過 DoT 類效果會受抗性影響，也可能發生暴擊。',
  '武器のダメージを33%上昇させ、防具の防御力を50%上昇させる。 戦闘終了時に低確率で耐久度を消耗し、耐久がなくなると装備が消滅する。':
    '武器 Damage 提高 33%，防具防禦力提高 50%。戰鬥結束時有低機率消耗耐久度；耐久度歸零時裝備會消失。',
  '不滅があるとエーテルの耐久が減少しなくなる。Fyrm ルーンで付与することが可能。 特定のセットやレジェンダリー装備には確定で不滅が付与されるものがある。 エーテルが付与されていない状態の不滅は特に意味がない。':
    '有不滅時，乙太裝備的耐久度不會下降。可透過 Fyrm 符文賦予不滅；部分 Set 或傳奇（Legendary）裝備也會固定帶有不滅。若裝備沒有乙太，不滅本身沒有特別意義。',
  '武器・サブ・頭・胴体の装備に備わり、ソケットの数だけルーンを装着できる。 一度装着したルーンは外したり消したりはできない。':
...
const PAGE_MANUAL_TRANSLATIONS = {
  'itemmods.html': {
    ステータス: '能力值',
    布製: '布甲',
    革製: '皮甲',
    メイル: '鎖甲',
    プレート: '板甲',
    'すべての才能\nすべてのクラスのすべてのタレントを上昇させる。':
      '所有天賦\n提高所有職業的所有天賦。',
    '全属性 クラス名 才能\n該当するクラスのすべてのタレントを上昇させる。':
      '全屬性 職業名稱 天賦\n提高指定職業的所有天賦。',
    '才能ツリー\n該当するタレントツリー内のすべてのタレントを上昇させる。':
      '天賦樹\n提高指定天賦樹內的所有天賦。',
    '属性 才能\n出血、毒、アーケイン、雷、炎、氷。 すべてのクラスの該当する属性を持つタレントを上昇させる。 複数の属性を持つスキルは片方のみが適用される。 たとえばドルイドの Tornado は氷とアーケインのスキルだが、氷 才能のみが適用される。':
      '屬性天賦\n出血、毒素、Arcane、閃電、火焰、冰冷。提高所有職業中帶有該屬性的天賦。若技能同時有多種屬性，只會套用其中一種。例如德魯伊的 Tornado 同時是冰冷與 Arcane 技能，但只會套用冰冷天賦。',
    'タレント\n該当するタレントを上昇させる。': '天賦\n提高指定天賦。',
...
function pageScopedTranslator(translator, page) {
  const overrides = PAGE_MANUAL_TRANSLATIONS[page.file] ?? {};
  if (Object.keys(overrides).length === 0) return translator;
  const exact = (value) => (Object.hasOwn(overrides, value) ? overrides[value] : null);
  return {
    get(value) {
      return exact(value) ?? translator.get(value);
    },
    local(value) {
      return exact(value) ?? translator.local(value);
    },
  };
}
...
function renderPage(page, translator, imageByUrl) {
  translator = pageScopedTranslator(translator, page);
  const lines = [
